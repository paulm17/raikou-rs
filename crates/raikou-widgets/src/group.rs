//! The Group component — a horizontal row of children.
...
/// Builder for a [`crate::Group`] component (horizontal row).
...
impl Group {
    ...
    /// Builds the group and adds it to the UI.
...
/// A handle to a built group.
pub type GroupHandle = Handle<UiNode>;
