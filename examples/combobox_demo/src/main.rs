//! combobox_demo — exercises the Phase 4 Combobox component (read-only
//! dropdown with a default placeholder).
...
fn build_demo_panel(
    ...
    let heading = Label::new("Combobox")
        .font_size(18.0)
...
fn main() {
    raikou_demo::run(
        Options {
            title: "raikou — combobox demo".to_string(),
            width: 900,
            height: 600,
        },
